...
const skills: Skill[] = [
  ...
  { name: 'Django RestFrameWork', category: 'Backend', level: 95 },
  { name: 'Django-Rest-Auth', category: 'Backend', level: 95 },
  { name: 'SimpleJWT-Auth', category: 'Backend', level: 95 },
  { name: 'Node/Express.js', category: 'Backend', level: 75 },
  { name: 'Python', category: 'Language', level: 90 },
  { name: 'JavaScript', category: 'Language', level: 50 },
  { name: 'PostgreSQL', category: 'Database', level: 95 },
  { name: 'MongoDB', category: 'Database', level: 80 },
  { name: 'React', category: 'Frontend', level: 50 },
  { name: 'HTML/CSS/JS', category: 'Frontend', level: 95 },
...
const projects: Project[] = [
  {
    title: 'AVAXTRADE', 
    description: 'A secure trading platform & Crypto wallet storage.',
    tech: ['Python', 'Django', 'Django-RestFrameWork', 'PostgreSQL'],
    link: 'https://avaxtrade.vercel.app',
    live: '#',
    featured: true,
  },
  {
    title: 'GROWTHSPHERE',
    description:'A financial planning platform with email-based auth, JWT login, KYC ID upload, crypto transactions, and balance tracking — built with Django and React.',
    tech: ['Django', 'React', 'PostgreSQL'],
    link: 'https://growth-one-phi.vercel.app/',
    live: '#',
    featured: true,
  },

  {
    title: 'COMPRE PHARMACEUTICALS',
    description:'A pharmaceutical platform that streamlines supply chains by modernizing procurement processes which aim to transform healthcare outcomes across Africa.',
    tech: ['React', 'CSS'],
    link: 'https://getcompre.com/',
    live: '#',
    featured: true,
  },
...
const socialLinks = [
  { icon: Mail, label: 'Email', href: 'mailto:akanforte@gmail.com' },
  { icon: Github, label: 'GitHub', href: 'https://github.com/amorgrace' },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/akan-sunday-686276314/',
  },

  { icon: Download, label: 'Resume', href: '/Akan_CV.pdf' },
];
...
export default function Portfolio() {
  ...
  const fullText = 'Backend-Focused Engineer';
      ...
      >
        ...
        <nav className='fixed top-0 w-full nav-bg backdrop-blur-md border-b nav-border z-50'>
          <div className='max-w-6xl mx-auto px-4 py-4'>
            <div className='flex justify-between items-center'>
              <a href='https://github.com/amorgrace' target="_blank">
                <motion.div
                  whileHover={{ scale: 1.05 }}
            ...
            >
              ...
              >
                ...
                <Button
                  variant='outline'
                  size='lg'
                  onClick={() => window.open('https://github.com/amorgrace', '_blank')}
                >
                ...
                <Button
                  ...
                  size='lg'
                  onClick={() =>
                    window.open('/Akan_CV.pdf', '_blank')
                  }
                >
            ...
            <div className='grid md:grid-cols-2 gap-12 items-center'>
              ...
              >
                <p className='about-text text-lg leading-relaxed'>
                  I'm a passionate backend developer with a strong focus on building
                   scalable systems. I specialize in designing robust architectures, 
                   optimizing database performance, and developing high-performance 
                   APIs capable of handling millions of requests efficiently.
                </p>
                <p className='about-text text-lg leading-relaxed'>
        ...
        <section id='contact' className='py-20 px-4 contact-section'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <a href='https://wa.me/2349039390620'>
                <Button size='lg'>
        ...
        <footer className='footer py-8 px-4 border-t'>
          <div className='flex max-w-6xl mx-auto text-center justify-center space-x-4 items-center'>
            <div>
              <p className='footer-text'>&copy; 2025 Akan Sunday —— All rights reserved.</p>
            </div>
